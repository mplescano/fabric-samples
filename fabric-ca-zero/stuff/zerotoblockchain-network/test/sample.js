...
describe('Finance Network', function () {
    ...
    before(function () {
        ...
        return businessNetworkConnection.connect('admin-peer-org2-mplescano-com@zerotoblockchain-network');
    });
    ...
    describe('#createOrder', () => {
        ...
        it('should be able to create an order', () => {
            ...
            console.log('create the buy transaction');
            const createNew = factory.newTransaction(NS, 'CreateOrder');

            console.log('create newRelationship for order');
            ...
            console.log('create newRelationship for createNew Tx');
            ...
            return businessNetworkConnection.getAssetRegistry(NS + '.Order')
                .then((assetRegistry) => {
                    ...
                    console.log('add the order to the asset registry');
                    return assetRegistry.add(order)
                        .then(() => {
                            return businessNetworkConnection.getParticipantRegistry(NS + '.Buyer');
                        })
                        .then((participantBuyerRegistry) => {
                            // add the buyer and seller
                            console.log('add the buyer');
                            return participantBuyerRegistry.add(buyer);
                        })
                        .then(() => {
                            return businessNetworkConnection.getParticipantRegistry(NS + '.Seller');
                        })
                        .then((participantRegistry) => {
                            // add the seller, shipper, provider
                            console.log('add the seller, shipper, provider');
                            return participantRegistry.addAll([seller, shipper, provider]);
                        })
                        .then(() => {
                            // submit the transaction
                            console.log('submit the transaction');
                            //displayObjectValues ('createNew', createNew);
                        ...
                        .then((assetRegistry) => {
                            ...
                            console.log('re-get the commodity');
                            return assetRegistry.get(orderNo);
                        })
                        .then((newOrder) => {
                            // the owner of the commodity should not be simon
                            console.log('the owner of the commodity should not be simon');
